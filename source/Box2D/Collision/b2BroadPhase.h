...
// by 0xtob: I replaced USHRT_MAX by USHRT_MAX/2 in the broadphase, because of
// overflow problems with the fixed point class, which has a 16-bit (i.e. short)
// integer part. So, when dealing with fixed point numbers about the size of
// USHRT_MAX, overflows occured. This reduces the precision by 1 bit, but oh well.
#define USHRT_MAX2	(USHRT_MAX/2)

const uint16 b2_invalid = USHRT_MAX2;
const uint16 b2_nullEdge = USHRT_MAX2;
