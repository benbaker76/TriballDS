...
public:
	...
	Fixed GetMotorForce(Fixed invTimeStep) const;

	void SetMotorSpeed(Fixed speed);
	void SetMotorForce(Fixed force);
	...
	Fixed m_initialAngle;

	b2Jacobian m_linearJacobian;
	Fixed m_linearMass;				// effective mass for point-to-line constraint.
	Fixed m_linearImpulse;
	
	Fixed m_angularMass;			// effective mass for angular constraint.
	Fixed m_angularImpulse;

	b2Jacobian m_motorJacobian;
	Fixed m_motorMass;			// effective mass for motor/limit translational constraint.
