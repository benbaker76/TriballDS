...
const Fixed b2_minPulleyLength = b2_lengthUnitsPerMeter;
...
public:
	...
	Fixed GetLength1() const;
	Fixed GetLength2() const;
	...
	Fixed m_pulleyImpulse;
	Fixed m_limitImpulse1;
	Fixed m_limitImpulse2;

	// Position impulses for accumulation.
	Fixed m_limitPositionImpulse1;
	Fixed m_limitPositionImpulse2;
